...
Frontend Software Engineer | React - JavaScript - CSS

I'm a Software Engineering graduate focused on building responsive, user-friendly web applications with React and modern JavaScript. I enjoy turning product requirements into clean, intuitive UI and interactive experiences.
...
- Created a responsive React-based online menu with reusable components.
- Implemented real-time business hour logic to dynamically enable or disable ordering.
...
**Other Languages:**  
![C](https://img.shields.io/badge/C-00599C?style=flat&logo=c) ![C++](https://img.shields.io/badge/C++-00599C?style=flat&logo=c%2B%2B) ![Python](https://img.shields.io/badge/Python-3776AB?style=flat&logo=python) 
